...
//! * Feature `tui` enables interactive helpers such as `polyfmt::tui::choose_one` and `choose_many`; they draw directly
//!   to stdout/tty and are not suitable for custom output targets.
//!
